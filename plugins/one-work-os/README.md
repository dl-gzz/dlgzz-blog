...
This is a thin WorkBuddy/CodeBuddy plugin. It installs the `one-work-os` Skill and connects the remote one-worker-os MCP server at `https://www.dlgzz.com/mcp`.
