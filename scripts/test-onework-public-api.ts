/**
 * Isolated OneWorkOS public/local API E2E test.
 *
...
async function main() {
  ...
  try {
    ...
    await sql.begin(async (transaction) => {
      ...
      await transaction`
        insert into api_key (
          ...
          ${apiKeyId}, ${userId}, 'OneWorkOS Public API E2E',
      ...
      await transaction`
        insert into onework_device (
          ...
          'OneWorkOS Public API E2E', 'test', 'active', now(), now()
        )
      `;
    ...
    console.log('✅ OneWorkOS public API E2E passed', {
