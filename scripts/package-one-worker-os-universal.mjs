      ...
      JSON.stringify(
        {
          ...
          description:
            '面向 WorkBuddy、豆包和龙虾（OpenClaw）的统一 one-worker-os MCP 安装包',
          mcp: {
