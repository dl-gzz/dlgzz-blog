...
export default function PaymentSuccessDemoPage() {
        ...
        <div className="bg-white rounded-2xl shadow-2xl overflow-hidden">
          ...
          <div className="px-8 py-8">
            <div className="mb-8">
              ...
              <div className="bg-gray-50 rounded-xl p-5 space-y-3">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span className="font-semibold text-gray-900">Pro 专业版</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-gray-600">付款周期</span>
                  <span className="font-semibold text-gray-900">月付</span>
                </div>
                <div className="border-t border-gray-200"></div>
                <div className="flex justify-between items-center">
              ...
              <div className="flex">
                ...
                <div className="ml-3">
                  <p className="text-sm text-green-800">
                    这是演示模式的成功页面，展示了支付成功后的 UI 效果。在实际使用时，这里会显示真实的订单信息，并发送确认邮件。
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-3">
              ...
              <button
                onClick={() => router.push('/payment/checkout-demo?aoid=' + aoid)}
