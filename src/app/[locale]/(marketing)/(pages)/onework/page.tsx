...
export async function generateMetadata({
  ...
  return constructMetadata({
    title: 'one-worker-os 会员与 WorkBuddy 连接',
    description:
      '开通 one-worker-os 会员，安装 WorkBuddy 插件并通过网页授权开始使用。Mac 与 Windows 使用同一流程，无需 API Key。',
    ...
    <Container className="px-4 py-12 sm:py-16">
      <div className="mx-auto max-w-6xl space-y-8">
        <div className="space-y-3">
          <p className="text-sm font-medium text-primary">one-worker-os</p>
          <h1 className="text-balance text-3xl font-bold tracking-tight sm:text-4xl">
            连接 one-worker-os，只需要一条清晰的流程
          </h1>
