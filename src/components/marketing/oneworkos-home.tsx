...
const workflowSteps: Array<{
  ...
  },
  {
    ...
    title: '理解当前阶段',
    description:
      'one-worker-os 会识别你想解决的问题，并在需要时询问你现在进行到了哪一步。',
    icon: Compass,
  },
  {
    number: '03',
  ...
  return (
    <div className="overflow-hidden bg-[#f8fbff] text-slate-950">
      <section className="relative isolate overflow-hidden bg-[#07172e] px-4 pb-20 pt-14 text-white sm:pt-20 lg:pb-28">
        <div
          aria-hidden
          className="absolute inset-0 -z-10 bg-[radial-gradient(circle_at_50%_0%,rgba(50,128,255,.34),transparent_32%),radial-gradient(circle_at_8%_18%,rgba(44,212,255,.16),transparent_25%),linear-gradient(135deg,#07172e_0%,#0b2450_52%,#06142a_100%)]"
        />
        <div
          aria-hidden
          className="absolute inset-0 -z-10 opacity-20 [background-image:linear-gradient(rgba(255,255,255,.18)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,.18)_1px,transparent_1px)] [background-size:52px_52px]"
        />
        ...
        <div className="mx-auto max-w-7xl">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <h1 className="mt-7 text-balance text-4xl font-semibold tracking-tight sm:text-6xl lg:text-7xl">
            ...
            <div className="mt-9 flex flex-col justify-center gap-3 sm:flex-row">
              ...
              >
                <LocaleLink href="/ai-chat">
                  立即使用 one-worker-os <ArrowRight className="size-4" />
                </LocaleLink>
              </Button>
              <Button
                asChild
          ...
          <div className="relative mx-auto mt-14 max-w-5xl rounded-[2rem] border border-white/15 bg-slate-950/55 p-3 shadow-2xl shadow-blue-950/40 backdrop-blur-xl sm:p-5">
            <div className="rounded-[1.5rem] border border-white/10 bg-[#0a1830] p-5 sm:p-7">
              ...
              <div className="mt-6 grid gap-4 lg:grid-cols-[1.05fr_.95fr]">
                <div className="rounded-2xl border border-white/10 bg-white/5 p-5">
                  ...
                  <div className="mt-5 flex items-center gap-2 text-xs text-cyan-200">
                ...
                <div className="rounded-2xl border border-blue-400/20 bg-[linear-gradient(135deg,rgba(37,99,235,.2),rgba(99,102,241,.12))] p-5">
                  ...
                  <div className="mt-4 space-y-3 text-sm text-slate-200">
                    <p className="flex items-center gap-2">
                      <CircleCheck className="size-4 text-cyan-300" />
                      匹配 WorkBuddy 知识包
                    </p>
                    <p className="flex items-center gap-2">
                      <CircleCheck className="size-4 text-cyan-300" />
              ...
              <div className="mt-4 grid grid-cols-3 gap-2 text-center text-[11px] text-slate-300 sm:gap-4 sm:text-sm">
                {['目标', '知识检索', '能力调度'].map((label, index) => (
                  <div
                    key={label}
                    className="relative rounded-xl border border-white/10 bg-white/5 px-2 py-3"
                  >
                    <span className="mr-1 text-cyan-300">0{index + 1}</span>
                    {label}
                    {index < 2 && (
                      <span
                        aria-hidden
                        className="absolute -right-4 top-1/2 hidden h-px w-4 bg-cyan-300/50 lg:block"
                      />
                    )}
                  </div>
                ))}
      ...
      <section
        id="capabilities"
        className="border-y border-blue-100 bg-[#f1f7ff] px-4 py-20 sm:py-28"
      >
        <div className="mx-auto max-w-6xl">
      ...
      <section className="px-4 py-20 sm:py-28">
        <div className="mx-auto max-w-6xl">
          ...
          <div className="mt-12 grid gap-5 lg:grid-cols-3">
            <article
              className={`${cardClass} relative overflow-hidden bg-gradient-to-br from-white to-blue-50`}
            >
            ...
            <article
              className={`${cardClass} relative overflow-hidden bg-gradient-to-br from-white to-cyan-50`}
            >
              <Store className="size-7 text-cyan-600" />
              ...
              <div className="mt-6 space-y-2 border-t border-cyan-100 pt-5 text-sm text-slate-600">
                <p>“我刚开小红书店，下一步做什么？”</p>
                <p>“小红书店铺怎么设置发货？”</p>
                <p>“店铺类型如何变更？”</p>
              </div>
            ...
            <article
              className={`${cardClass} relative overflow-hidden bg-gradient-to-br from-white to-indigo-50`}
            >
              <PenTool className="size-7 text-indigo-600" />
              ...
              <div className="mt-6 grid grid-cols-3 gap-2 border-t border-indigo-100 pt-5 text-indigo-600">
        ...
        <div className="mx-auto max-w-6xl">
          ...
          <div className="mt-12 overflow-hidden rounded-3xl border border-white/10">
            <div className="grid md:grid-cols-2">
              <div className="border-b border-white/10 bg-white/5 p-7 md:border-b-0 md:border-r">
                <p className="text-sm font-medium text-slate-400">普通知识库</p>
      ...
      <section className="px-4 py-20 sm:py-28">
        <div className="mx-auto grid max-w-6xl items-center gap-12 lg:grid-cols-[.9fr_1.1fr]">
          ...
          <div className="grid gap-4 rounded-[2rem] border border-blue-100 bg-blue-50/70 p-5 sm:grid-cols-2 sm:p-7">
      ...
      <section id="membership" className="px-4 py-20 sm:py-28">
        <div className="mx-auto max-w-6xl rounded-[2rem] bg-[linear-gradient(135deg,#082658,#0b4fb6_55%,#1676ff)] p-1 shadow-2xl shadow-blue-200">
          <div className="rounded-[1.8rem] bg-[#071e47]/92 px-6 py-12 text-white sm:px-12 sm:py-14">
            <div className="grid items-center gap-10 lg:grid-cols-[1fr_.8fr]">
              <div>
                <SectionEyebrow>one-worker-os 会员</SectionEyebrow>
                <h2 className="mt-5 text-3xl font-semibold tracking-tight sm:text-5xl">
                  安装一次，持续获得全部知识能力
                </h2>
                <ul className="mt-7 grid gap-3 text-slate-200 sm:grid-cols-2">
                  {[
                    '使用全部 one-worker-os 知识库',
                    '每月 1000 次知识检索',
                    'WorkBuddy 与小红书知识能力',
                    '官方图片、资料出处和视频入口',
                    '云端知识持续更新',
              ...
              <div className="rounded-3xl border border-white/15 bg-white/10 p-7 backdrop-blur">
                <p className="text-sm text-blue-100">one-worker-os 会员</p>
                ...
                >
                  <LocaleLink href="/pricing">
                    立即开通 one-worker-os <ArrowRight className="size-4" />
                  </LocaleLink>
                </Button>
      ...
      <section className="px-4 pb-24 pt-8 sm:pb-32">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <h2 className="mt-5 text-balance text-3xl font-semibold tracking-tight sm:text-5xl">
            不用先学会工具，先告诉 one-worker-os 你想完成什么
          </h2>
          ...
          >
            <LocaleLink href="/ai-chat">
              开始使用 one-worker-os <ArrowRight className="size-4" />
            </LocaleLink>
          </Button>
        </div>
      </section>
